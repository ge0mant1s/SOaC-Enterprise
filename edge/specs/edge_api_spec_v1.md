...
> **Publisher:** SOaC Core Team | **Version:** 1.0.1 | **Date:** March 2026  > **License:** Apache 2.0 | **Repository:** github.com/ge0mant1s/SOaC-Enterprise
...
| `422` | `PROVIDER_UNAVAILABLE` | Target provider is unreachable |
...
EDGE_BASE_URL = "https://edge.soac.io"
...
| --- | --- | --- |
| 1.0.1 | 2026-03-13 | Fix base URL vs path duplication; minor spec polish |
