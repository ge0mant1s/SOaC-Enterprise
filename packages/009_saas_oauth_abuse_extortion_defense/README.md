...
> **Package ID:** pkg-009 | **Tier:** Advanced | **Difficulty:** 3/4

## Overview

Detect and respond to SaaS OAuth abuse and data extortion techniques.
...
`gtr-2025` · `saas` · `oauth` · `extortion` · `defense`
